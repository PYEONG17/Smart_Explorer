...
-- CreateEnum
CREATE TYPE "MaterialType" AS ENUM ('PDF', 'DOCUMENT', 'MODEL_3D', 'OTHER');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('QUESTION', 'EXPLANATION', 'QUIZ');
...
-- AddForeignKey
ALTER TABLE "InteractiveActivity" ADD CONSTRAINT "InteractiveActivity_videoId_fkey" FOREIGN KEY ("videoId") REFERENCES "Video"("id") ON DELETE CASCADE ON UPDATE CASCADE;
